...
function bubur(date,month,year,mauApa){
	...
	var viewsJuly=[5326,5333,5341,5346,5355,5367,5375];
	var viewsAugust=[];
	if (year==2021){
...
function bawal(date,month,year,mauApa){
	...
	var viewsJuly=[5905,5918,5927,5935,5947,5964,5978];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function lidahBuaya(date,month,year,mauApa){
	...
	var viewsJuly=[3619,3626,3634,3637,3642,3652,3660];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function sopSopan(date,month,year,mauApa){
	...
	var viewsJuly=[3868,3876,3887,3894,3911,3929,3940];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function oyong(date,month,year,mauApa){
	...
	var viewsJuly=[3342,3351,3358,3364,3373,3384,3393];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function cacana(date,month,year,mauApa){
	...
	var viewsJuly=[2757,2766,2775,2780,2786,2800,2811];
	var viewsAugust = [];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function berkebun(date,month,year,mauApa){
	...
	var viewsJuly=[1913,1924,1934,1940,1952,1964,1975];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function wiladatika(date,month,year,mauApa){
	...
	var viewsJuly=[1304,1332,1349,1360,1375,1400,1425];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function apel(date,month,year,mauApa){
	...
	var viewsJuly=[2695,2764,2840,2882,2952,3022,3104];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function jeruk(date,month,year,mauApa){
	...
	var viewsJuly=[130,187,222,243,270,310,373];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==6&&mauApa==1){return viewsJune[date-1];}

...
function bubur(date,month,year,mauApa){
	...
	var viewsJune = [5052,5064,5072,5082,5089,5101,5109,
					/*8*/5117];
	var viewsJuly = [];
	var viewsAugust = [];
...
function bawal(date,month,year,mauApa){
	...
	var viewsJune = [5294,5313,5339,5362,5390,5417,5434,
					/*8*/5452
					];
	var viewsJuly = [];
	var viewsAugust = [];
...
function lidahBuaya(date,month,year,mauApa){
	...
	var viewsJune = [3359,3368,3377,3387,3394,3405,3414,
					/*8*/3421
					];
	var viewsJuly = [];
	var viewsAugust = [];
...
function sopSopan(date,month,year,mauApa){
	...
	var viewsJune = [3554,3565,3579,3589,3605,3618,3626,
					/*8*/3639,
					];
	var viewsJuly = [];
	var viewsAugust = [];
...
function oyong(date,month,year,mauApa){
	...
	var viewsJune = [2966,2977,2988,3000,3017,3034,3047,
					/*8*/3059
					];
	var viewsJuly = [];
	var viewsAugust = [];
...
function cacana(date,month,year,mauApa){
	...
	var viewsJune = [2443,2456,2466,2475,2483,2497,2508,
					/*8*/2516
					];				
	var viewsJuly = [];
	var viewsAugust = [];
...
function berkebun(date,month,year,mauApa){
	...
	var viewsJune = [1564,1581,1594,1607,1617,1632,1641,
					/*8*/1654
					];				
	var viewsJuly = [];
	var viewsAugust = [];
...
function wiladatika(date,month,year,mauApa){
	...
	var viewsJune = [627,644,662,679,693,711,725,
					/*8*/741
					];
	var viewsJuly = [];
	var viewsAugust = [];
...
function apel(date,month,year,mauApa){
	...
	var viewsJune = [223,241,283,309,333,376,425,
					/*8*/476
					];
	var viewsJuly = [];
	var viewsAugust = [];
...
function tableBuilder(date, month, year, videonum){
	...
	var thistimeView, nextView, tanggalSelanjutnya, tanggalSebelumnya, previousView, previousViewMonth, nextViewMonth, previousViewYear, nextViewYear;
	document.write("<h3>Bulan "+monthSelector(month)+"</h3>");
	document.write("<div class='tableWrapper'>")
	document.write("<table class='viewsData'>");
	document.write("<tr>");
	for (var column = 1; column <= daysInMonth; column++){document.write("<th>"+tH(column, month, year)+"</th>");}

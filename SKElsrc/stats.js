...
function bubur(date,month,year,mauApa){
	...
	var viewsJuly=[5326,5333,5341,5346,5355,5367,5375,5389,5396,5405,5415,5424,5431,5440,5449,5457];
	var viewsAugust=[];
	if (year==2021){
...
function bawal(date,month,year,mauApa){
	...
	var viewsJuly=[5905,5918,5927,5935,5947,5964,5978,5993,6005,6016,6027,6035,6047,6059,6074,6085];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function lidahBuaya(date,month,year,mauApa){
	...
	var viewsJuly=[3619,3626,3634,3637,3642,3652,3660,3673,3680,3692,3700,3711,3716,3725,3735,3744];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function sopSopan(date,month,year,mauApa){
	...
	var viewsJuly=[3868,3876,3887,3894,3911,3929,3940,3953,3961,3984,3994,4008,4014,4023,4033,4043];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function oyong(date,month,year,mauApa){
	...
	var viewsJuly=[3342,3351,3358,3364,3373,3384,3393,3408,3418,3432,3441,3454,3462,3471,3483,3493];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function cacana(date,month,year,mauApa){
	...
	var viewsJuly=[2757,2766,2775,2780,2786,2800,2811,2821,2828,2841,2852,2863,2870,2879,2890,2898];
	var viewsAugust = [];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function berkebun(date,month,year,mauApa){
	...
	var viewsJuly=[1913,1924,1934,1940,1952,1964,1975,1985,1994,2005,2014,2025,2039,2054,2068,2083];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function wiladatika(date,month,year,mauApa){
	...
	var viewsJuly=[1304,1332,1349,1360,1375,1400,1425,1464,1478,1498,1518,1540,1547,1564,1590,1605];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function apel(date,month,year,mauApa){
	...
	var viewsJuly=[2695,2764,2840,2882,2952,3022,3104,3165,3231,3314,3392,3474,3582,3667,3741,3821];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==5&&mauApa==1){return viewsMay[date-1];}
...
function jeruk(date,month,year,mauApa){
	...
	var viewsJuly=[130,187,222,243,270,310,373,443,484,528,572,610,647,676,709,731];
	var viewsAugust=[];
	if (year==2021){
		if(month==0){return viewsMay.length;}
		else if(month==6&&mauApa==1){return viewsJune[date-1];}

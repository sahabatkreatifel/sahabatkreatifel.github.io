...
function bubur(date,month,year,mauApa){
	...
	var viewsJune = [5052,5064,5072,5082,5089,5101,5109,5117,5125,5134,5143,5154,5161,5172,5178,5185,5199];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
...
function bawal(date,month,year,mauApa){
	...
	var viewsJune = [5294,5313,5339,5362,5390,5417,5434,5452,5477,5491,5511,5532,5546,5571,5594,5616,5646];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function lidahBuaya(date,month,year,mauApa){
	...
	var viewsJune = [3359,3368,3377,3387,3394,3405,3414,3421,3429,3436,3441,3453,3465,3473,3479,3487,3494];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function sopSopan(date,month,year,mauApa){
	...
	var viewsJune = [3554,3565,3579,3589,3605,3618,3626,3639,3649,3659,3668,3679,3692,3701,3712,3722,3731];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function oyong(date,month,year,mauApa){
	...
	var viewsJune = [2966,2977,2988,3000,3017,3034,3047,3059,3074,3085,3095,3107,3119,3131,3138,3148,3167];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function cacana(date,month,year,mauApa){
	...
	var viewsJune = [2443,2456,2466,2475,2483,2497,2508,2516,2525,2536,2542,2552,2562,2570,2577,2591,2604];				
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function berkebun(date,month,year,mauApa){
	...
	var viewsJune = [1564,1581,1594,1607,1617,1632,1641,1654,1663,1675,1683,1692,1700,1708,1715,1729,1743];				
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function wiladatika(date,month,year,mauApa){
	...
	var viewsJune = [627,644,662,679,693,711,725,741,754,767,779,791,808,824,835,849,867];
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
...
function apel(date,month,year,mauApa){
	...
	var viewsJune = [223,241,283,309,333,376,425,476,541,582,639,682,738,798,838,908,1046]
	var viewsJuly = [];
	var viewsAugust = [];
	if (year == 2021){
		if (month == 0){return viewsMay.length;}
